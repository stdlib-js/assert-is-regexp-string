...
-   [`@stdlib/assert/is-regexp`][@stdlib/assert/is-regexp]: test if a value is a regular expression.
...
[test-image]: https://github.com/stdlib-js/assert-is-regexp-string/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-is-regexp-string/actions/workflows/test.yml
