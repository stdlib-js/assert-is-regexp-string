...
tape( 'the command-line interface tests if a string argument is a regular expression', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'/beep/gim\'; require( \''+fpath+'\' );"'
	];
